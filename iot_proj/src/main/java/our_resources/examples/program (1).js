bp.registerBThread('Landing strip', function(){
  while (true) {
    ...
    request: bp.Event('Landing strip: clear for landing')});
...
bp.registerBThread('Tower', function(){
  while (true) {
    ...
    request: bp.Event('Tower: airplane approaching')});
